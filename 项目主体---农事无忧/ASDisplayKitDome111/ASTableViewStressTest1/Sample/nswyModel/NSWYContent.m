...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
      self.ID = [self objectOrNilForKey:kNSWYContentID fromDictionary:dict] ;
            self.isNewRecord =  [self objectOrNilForKey:kNSWYContentIsNewRecord fromDictionary:dict]  ;
            ...
            self.fstate =  [self objectOrNilForKey:kNSWYContentFstate fromDictionary:dict]  ;
            ...
            self.forigin =  [self objectOrNilForKey:kNSWYContentForigin fromDictionary:dict]  ;
...
- (NSDictionary *)dictionaryRepresentation
{
  ...
  [mutableDict setObject:self.ID forKey:kNSWYContentID];
    ...
    [mutableDict setValue: self.fstate  forKey: kNSWYContentFstate ];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
  ...
  self.ID = [aDecoder decodeObjectForKey:kNSWYContentID];
    self.isNewRecord = [aDecoder decodeObjectForKey:kNSWYContentIsNewRecord];
    ...
    self.fstate = [aDecoder decodeObjectForKey:kNSWYContentFstate];
    ...
    self.forigin = [aDecoder decodeObjectForKey:kNSWYContentForigin];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
  [aCoder encodeObject:_ID forKey:kNSWYContentID];
    ...
    [aCoder encodeObject:_fstate forKey:kNSWYContentFstate];
    ...
    [aCoder encodeObject:_forigin forKey:kNSWYContentForigin];
